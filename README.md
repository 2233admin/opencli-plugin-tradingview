...
- **Extraction adapters** (`news`, `financials`, `technicals`, `econ-calendar`) — verified end-to-end against live TradingView on both a US ticker (`AAPL`) and an A-share (`600519`). These return real rows.
